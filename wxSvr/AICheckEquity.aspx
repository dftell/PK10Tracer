<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AICheckEquity.aspx.cs" Inherits="AICheckEquity" %>
<html><head>
  <meta charset="utf-8">
    ...
    <div class="wxapi_index_container">
        <form>
            <table width="100%">
                ...
                <tr>
                    <td><input type="number" id="txt_code" max="6" value=""/></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <button class="btn btn_primary"  type="submit" id="submit">提交</button>
                    </td>
                </tr>
            </table>
        </form>
...
<script>
  ...
  wx.config({
      debug: false,
      appId: 'wx8e34dcb86f5c900b',
      timestamp: 1599154416,
      nonceStr: 'LtjF1x021apfkOKWmqDnauCt3wm2jCMUGR4oJFwQpIU',
      signature: 'HappyShareETech',
      jsApiList: [
        'checkJsApi',
        'onMenuShareTimeline',
...
<script src="jscript/zepto.min.js"></script>
