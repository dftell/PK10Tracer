...
namespace WolfInv.com.WebRuleLib
{
    public abstract class LotteryConfigClass
    {
        ...
        protected LotteryConfigClass(WebRule we, LotteryTypes rs)
        {
            rules = rs;
            wr = we;
        }
    ...
    public abstract class FHPLotteryConfigClass : LotteryConfigClass
    {
        ...
        protected FHPLotteryConfigClass(WebRule we, LotteryTypes rs) : base(we, rs)
        {
        }
    }
    /// <summary>
    ...
    public abstract class F2LotteryyConfigClass : FHPLotteryConfigClass
    {
        ...
        protected F2LotteryyConfigClass(WebRule we, LotteryTypes rs) : base(we, rs)
        {
        }
    }
    /// <summary>
    ...
    public class PK10KindLotteryConfigClass: F2LotteryyConfigClass
    {
        ...
        public PK10KindLotteryConfigClass(WebRule we, LotteryTypes rs) : base(we, rs)
        {
    ...
    {
        public LotteryConfigClass_XYFT(WebRule we, LotteryTypes rs) : base(we, rs)
        {
    ...
    public class LotteryConfigClass_A11C5 : LotteryConfigClass
    {


        public LotteryConfigClass_A11C5(WebRule we, LotteryTypes rs) : base(we, rs)
        {
            rules = rs;
            wr = we;
    ...
    public class Rule_ForKcaiCom : WebRule
    {
            ...
            : base(setting)
        {
            ...
            Load("rule_kcai.xml", "config\\Rules\\kcai");
        ...
        public override string IntsToJsonString(string lotteryName, String ccs, int unit)
        {
            ...
            switch (lotteryName)
            {
                case "PK10":
                    {
                        lcc = new PK10KindLotteryConfigClass(this,lt);
                        break;
                    }
                case "XYFT":
                    {
                        lcc = new LotteryConfigClass_XYFT(this,lt); 
                        break;
                    }
                default:
                    {
