...
namespace WolfInv.com.SecurityLib
{
    ...
    public class Web52CP_HtmlDataClass : HtmlDataClass
    {
        public Web52CP_HtmlDataClass(DataTypePoint dp) : base(dp)
        {
        ...
        public override ExpectList<T> getJsonData<T>(string strXml)
        {
            ...
            if(dc.result!=null)
            {
                for(int i=dc.result.Count-1;i>=0;i--)
                {
                    ...
                    ExpectData<T> data = new ExpectData<T>(false);
            ...
            ExpectList<T> res = new ExpectList<T>(false);
            //强制按时间倒序排列
        ...
        public static DataSet getDataSet(DataTypePoint dtp, string expect)
        {
