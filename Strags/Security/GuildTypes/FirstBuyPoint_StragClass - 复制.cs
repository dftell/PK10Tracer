...
namespace WolfInv.com.Strags.Security
{
    ...
    [DescriptionAttribute("缠后下跌选股策略"),
        DisplayName("缠后下探选股策略")]
    [Serializable]
    public class TwistWithAvgLine_StragClass<T> : BaseSecurityStragClass<T>  where T : TimeSerialData
    {        
        public TwistWithAvgLine_StragClass()
        {
            this._StragClassName = "缠后下跌选股策略";
