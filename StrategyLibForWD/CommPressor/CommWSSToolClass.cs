...
{
    public class CommWSSToolClass
    {
        static WindAPI commW;
        static CommWSSToolClass()
        {
            connectWd();
        }
        ...
        public static ExpectList GetBaseData(string[] codes, DateTime endt, Cycle cyc=Cycle.Day, PriceAdj prcAdj=PriceAdj.Fore, params object[] args)
        {
            ...
            var res = GetBaseData(commW, codes,endt, cyc, prcAdj, args);
            if(res == null)
            {
        ...
        {
            return GetBaseData(new string[] { code }, endt, cyc, prcAdj, args);
        }
        ...
        public static Dictionary<string, HashSet<string>> getMutliValueGuid(params string[] args)
        {
